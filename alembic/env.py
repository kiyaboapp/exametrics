...
# Import settings and Base from your app
from app.core.config import settings
from app.db.base import Base  # <- This should point to your SQLAlchemy Base metadata
...
# 🛑 Force pymysql for Alembic migrations, even if runtime uses aiomysql
